...
**applyFileLifetimeToFiles** | **kotlin.Boolean** | Apply file lifetime setting to existing files |  [optional]
**applyFileLifetimeToNested** | **kotlin.Boolean** | Apply file lifetime setting to nested folders |  [optional]
