...
open class JobsApi : ApiClient {
    ...
    open suspend fun restJobsIdGet(id: kotlin.Int): HttpResponse<Job> {
     ...
     * @return void
     */
    open suspend fun restJobsIdPost(id: kotlin.Int): HttpResponse<Unit> {
